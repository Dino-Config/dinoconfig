...
import { TimePickerElementComponent } from './time-picker-element/time-picker-element.component';
import { DatetimePickerElementComponent } from './datetime-picker-element/datetime-picker-element.component';
...
export const FIELD_COMPONENT_REGISTRY: Record<string, FieldComponentMap> = {
  ...
  time: { component: TimePickerElementComponent, selector: 'dc-time-picker-element' },
  'datetime': { component: DatetimePickerElementComponent, selector: 'dc-datetime-picker-element' },
...
export function getFieldComponentType(fieldType: FieldType): string {
  const textTypes: FieldType[] = ['text', 'email', 'password', 'url', 'tel', 'search'];
