    ...
    <div class="input-dialog">
      <div class="dialog-header">
        ...
        <div class="header-content">
          ...
          <h2 class="dialog-title">{{ data.title || 'Enter Value' }}</h2>
        </div>
      </div>
      <div class="dialog-content">
        <div class="input-wrapper">
          <label class="input-label">{{ data.label || 'Name' }}</label>
          <input 
            type="text" 
            class="dialog-input"
            [(ngModel)]="inputValue"
...
export class InputDialogComponent implements AfterViewInit {
  ...
  data = inject<{ title?: string; label?: string; defaultValue?: string }>(MAT_DIALOG_DATA);
