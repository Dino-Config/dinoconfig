...
export const VersionSelector: React.FC<VersionSelectorProps> = ({
  ...
  return (
    <div className={`version-selector ${isCollapsed ? 'collapsed' : ''}`}>
      <div className="version-selector__header" onClick={() => setIsCollapsed(!isCollapsed)}>
        <h3>Version History</h3>
        <div className="version-selector__header-right">
          ...
          <button className="version-selector__collapse-toggle" aria-label={isCollapsed ? 'Expand' : 'Collapse'}>
            <svg width="16" height="16" viewBox="0 0 16 16" fill="none" style={{ transform: isCollapsed ? 'rotate(-90deg)' : 'rotate(0deg)', transition: 'transform 0.2s' }}>
